...
public class UIManager : MonoBehaviour {
    ...
    void UpdateResUI(ResolutionScreenType type, int score)
    {
        ...
        switch (type)
        {
            ...
            case ResolutionScreenType.Incorrect:
                ...
                uIElements.ResolutionStateInfoText.text = "НЕВЕРНО!";
            ...
            case ResolutionScreenType.Finish:
                ...
                uIElements.HighScoreText.text = ((highscore > events.StartupHighscore) ? "<color=yellow>new </color>" : string.Empty) + "Лучшая оценка: " + highscore;
                break;
        }
    }
    ...
    IEnumerator CalculateScore()
    {
        ...
        scoreValue = events.CurrentFinalScore;
            ...
            if ((scoreValue >= 50) && (scoreValue <70))
            {
                scoreValue = 3;
                uIElements.ResolutionScoreText.text = scoreValue.ToString();
            }
            else if ((scoreValue >= 70) && (scoreValue < 90))
            {
                scoreValue = 4;
                uIElements.ResolutionScoreText.text = scoreValue.ToString();
            }
    ...
    void UpdateScoreUI()
    {
        uIElements.ScoreText.text = "Баллы: " + events.CurrentFinalScore;
    }
}